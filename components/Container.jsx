 ...
 * @param {ReactNode} porps.children => The content to be wrapped inside the container.
 * @param {string} [props.className] => Additional CSS clases to be applied to the container.
